...
<div class="bg-secondary rounded h-100 p-4">
    <div class="row my-4">
        <div class="col-10">
            <h2 class="main-title">Factories Management</h2>
        </div>
        <div class="col-2">
            <a href="<?php echo BASE_URL; ?>admin/add-factory" class="btn btn-outline-primary m-2">
                <i class="feather icon-plus"></i> Add New Factory
            </a>
        </div>
        ...
        <table class="table table-hover text-center align-middle">
            ...
            <tbody>
                <tr>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="text-center text-muted">No factorys found</td>
                        </tr>
                    <?php endif; ?>
                </tr>
            </tbody>
